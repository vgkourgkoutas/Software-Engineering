...
public class save_discount extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_save_discount);
        ...
        create_offer2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(save_discount.this, "Η προσφορά δημιουργήθηκε με επιτυχία", Toast.LENGTH_SHORT).show();
