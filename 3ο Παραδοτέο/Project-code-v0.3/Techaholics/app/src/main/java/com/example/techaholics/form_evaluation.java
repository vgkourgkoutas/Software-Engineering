...
public class form_evaluation extends AppCompatActivity {
    TextView feedback;
    RatingBar rbStars;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_evaluation);
        ...
        submform.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent startIntent = new Intent(getApplicationContext(), complete_evaluation.class);
                startActivity(startIntent);
            }
        });
