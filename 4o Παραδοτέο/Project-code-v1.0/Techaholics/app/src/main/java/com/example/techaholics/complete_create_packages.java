...
public class complete_create_packages extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_complete_create_packages);
        ...
        make_packet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(complete_create_packages.this, "Το πακέτο δημιουργήθηκε με επιτυχία", Toast.LENGTH_SHORT).show();
